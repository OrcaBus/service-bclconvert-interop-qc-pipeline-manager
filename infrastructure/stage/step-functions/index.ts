...
import {
  ...
  READY_STATUS,
  SAMPLE_FILTERS_PAYLOAD_VERSION_THRESHOLD,
  STEP_FUNCTIONS_DIR,
...
function createStateMachineDefinitionSubstitutions(props: BuildStepFunctionProps): {
  ...
  definitionSubstitutions['__sample_filters_payload_version_threshold__'] =
    SAMPLE_FILTERS_PAYLOAD_VERSION_THRESHOLD;
      ...
      [
        {
          id: 'AwsSolutions-IAM5',
          reason:
            'Wildcard covers ECS task definition revisions and container overrides; specific revision ARNs cannot be enumerated because new revisions are created on each deployment',
        },
      ],
      true
    );
      ...
      [
        {
          id: 'AwsSolutions-IAM5',
          reason:
            'Wildcard covers child execution names generated by distributed map; individual execution ARNs cannot be enumerated because they are created dynamically at runtime',
        },
      ]
    );
  }

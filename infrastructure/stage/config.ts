import {
  ...
  SSM_PARAMETER_PATH_DEFAULT_PAYLOAD_VERSION,
...
const getSsmParameterPaths = (): SsmParameterPaths => {
  return {
    ...
    // Payload
    defaultPayloadVersion: SSM_PARAMETER_PATH_DEFAULT_PAYLOAD_VERSION,
...
const getSsmParameterValues = (stage: StageName): SsmParameterValues => {
  return {
    ...
    // Payload
    defaultPayloadVersion: DEFAULT_PAYLOAD_VERSION,
